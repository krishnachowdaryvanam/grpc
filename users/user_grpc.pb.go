...
type UserServiceClient interface {
	...
	GetUsersByIds(ctx context.Context, in *UserIdsRequest, opts ...grpc.CallOption) (UserService_GetUsersByIdsClient, error)
}
...
func (c *userServiceClient) GetUsersByIds(ctx context.Context, in *UserIdsRequest, opts ...grpc.CallOption) (UserService_GetUsersByIdsClient, error) {
...
type UserServiceServer interface {
	...
	GetUsersByIds(*UserIdsRequest, UserService_GetUsersByIdsServer) error
...
func (UnimplementedUserServiceServer) GetUsersByIds(*UserIdsRequest, UserService_GetUsersByIdsServer) error {
